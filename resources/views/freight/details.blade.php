    ...
    <div style="padding: 25px">
        <div style="margin: 15px">
            ...
            <div>
                ...
                , {{ $freight->startAddress->city }}</span>
            </div>
            <div>
                <b>Loading date: </b>
                <span>{{ $freight->start_date }} {{ $freight->start_time_from }}</span>
            </div>
        </div>
        <div style="margin: 15px">
            <div>
        ...
        <div style="margin: 15px">
            ...
            <div>
                <b>Weight: </b>
                <span>{{ $freight->cargo->weight }} kg</span>
            </div>
        </div>
        <div style="margin: 15px">
            <div>
                <b>Truck: </b>
                <span>{{ $freight->truckType->name }}, {{ $freight->truck->name }}</span>
            </div>
            <div>
                <b>Freight type: </b>
                <span>{{ $freight->freightType->name }}</span>
            </div>
        </div>
        <div style="margin: 15px">
            <div>
            ...
            <div>
                ...
                <span>{{ $freight->forwarder->email }}</span>
            </div>
        </div>
        <div style="margin: 15px">
            <div>
                <b>Publication date: </b>
                <span>{{ $freight->created_at }}</span>
            </div>
        </div>
        <div style="margin: 15px">
